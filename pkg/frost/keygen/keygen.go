...
//}
//
//func (r *KeyGenRound1) GetMessagesOut() (messages *frost.Message, round *KeyGenRound2, err error) {
...
//	}
//
//	messages = &frost.Message{
//		KeyGen: &frost.KeyGenMessage{
...
//
//
//func (r *KeyGenRound2) ProcessMessage(from common.Party, msg *frost.Message) error {
//	found := false
...
//}
//
//func (r *KeyGenRoundFinal) ProcessMessage(from common.Party, msg *frost.Message) error {
//	found := false
//	for _, otherParty := range r.OtherPartyIDs {
//		found = found || (otherParty == from)
//	}
